...
interface Navigator {
    ...
    fun goToSpellsFrag(classID: Long)
    fun goToRedactCharacterFrag(character: CharacterData)
    fun goToNewCharacterFrag(item: AccountData, gameItem: GameData, ownerID: Long)
